...
We will look through the main parts of the Index TTS api implementation
that you can find in this repository [index-tts-api](https://github.com/sergiycheck/index-tts)
